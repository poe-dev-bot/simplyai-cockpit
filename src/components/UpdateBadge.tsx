      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              SimplyAi <span className="font-mono font-semibold text-foreground">v{versionInfo.latest}</span> is
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="text-xs text-muted-foreground space-y-1">
              ...
              <p>If anything fails, SimplyAi automatically rolls back to your current version.</p>
            </div>
            <div>
